...
if (__DEV__) {
  ...
  console.log("  - EXPO_PUBLIC_OPENAI_API_KEY:", process.env.EXPO_PUBLIC_OPENAI_API_KEY ? "✅ Found" : "❌ Missing")
  console.log("  - EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID:", process.env.EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID ? "✅ Found" : "❌ Missing")
}
...
export default {
  ...
  SUPABASE_KEY: Constants.expoConfig?.extra?.supabaseAnonKey || process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || "",
  SUPABASE_SERVICE_ROLE_KEY: "",
  OPENAI_API_KEY: Constants.expoConfig?.extra?.openaiApiKey || process.env.EXPO_PUBLIC_OPENAI_API_KEY || "",
  GOOGLE_WEB_CLIENT_ID: Constants.expoConfig?.extra?.googleWebClientId || process.env.EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID || "",
}
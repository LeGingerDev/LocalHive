...
const _isValidData = (data: CatalogCardData | null | undefined): data is CatalogCardData => {
  return data != null && typeof data === "object"
}

const _getDisplayTitle = (data: CatalogCardData | null | undefined): string => {
  if (!_isValidData(data)) return "No Title"
  return data.title ?? "Untitled"
}

const _getDisplayDescription = (data: CatalogCardData | null | undefined): string => {
...
// #region Component
/**
 * CatalogCard - A defensive component with proper error handling and loading states
 *
 * Features:
 ...
 */
export const CatalogCard: FC<CatalogCardProps> = memo((props) => {

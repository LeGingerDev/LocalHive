...
const _getDisplayDescription = (data: InviteButtonData | null | undefined): string => {
 ...
 */
export const InviteButton: FC<InviteButtonProps> = memo((props) => {

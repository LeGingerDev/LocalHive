...
export const SignUpScreen = () => {
  ...
  const handleSignUp = async () => {
    ...
    const { user, error: signUpError } = await AuthService.signUpWithEmail(email, password)
    if (user) {
      // Create profile in 'profiles' table
      await DatabaseService.create("profiles", {
        id: user.id,
        email,
        full_name: fullName,
    ...
    <Screen preset="fixed" contentContainerStyle={styles.container} safeAreaEdges={[]}>
      ...
      >
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.subtitle}>Join GroupHub today</Text>
...
const styles = StyleSheet.create({
  ...
  signInLink: { color: "white", fontSize: 14, fontWeight: "bold" },
  ...
  signUpButtonText: { color: "#7727c3", fontSize: 16, fontWeight: "bold" },
  socialButton: {
    alignItems: "center",
    backgroundColor: "rgba(255,255,255,0.2)",
    borderRadius: 8,
